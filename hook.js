    ...
    e.exports = function (e) {
      return new Promise(function (t, f) {
        ...
        if (l.open(e.method.toUpperCase(), i(y, e.params, e.paramsSerializer), !0), l.timeout = e.timeout, l.onreadystatechange = function () {
          ...
          var g = n(21), v = (e.withCredentials || u(y)) && e.xsrfCookieName ? g.read(e.xsrfCookieName) : void 0;
  ...
  function o(t) {
    ...
    return window[s] = window[s] || XMLHttpRequest, XMLHttpRequest = function () {
      ...
      for (var r in t) {
        ...
        "function" === i ? this[r] = o(r) : Object.defineProperty(this, r, {get: e(r), set: n(r), enumerable: !0})
      }
      var a = this;
      t.getProxy = function () {
        return a
